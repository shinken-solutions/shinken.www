            ...
            <div class="col-sm-3 "> 
                <div class="Content"> 
                    <a href="index.php" target="_blank">
                        <div class="Logo_Frame"> 
                            <img alt="Logo Ninja Framework Shinken" class="Logo" src="img/NinjaGreen.png">
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">
                    <img alt="Logo Shinken Framework" class="Logo" src="img/LogoFrameworkBlack.png">
                </a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav lavaLampBottomStyle" id="Lavalamp">
                    <li>
